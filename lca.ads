...
package LCA is
   ...
   -- Enregistrer une valeur associée Ã  une Clé dans une Sda.
   -- Si la clé est déja  présente dans la Sda, sa valeur est changée.
   ...
   -- Obtenir la valeur associée Ã  une Cle dans la Sda.
